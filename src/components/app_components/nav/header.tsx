        ...
        <>
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <LogOut className="size-7 cursor-pointer text-red-500" />
            </AlertDialogTrigger>
            <AlertDialogContent className="bg-black border-green-600 text-green-500">
              <AlertDialogHeader>
                <AlertDialogTitle>Thoát trận?</AlertDialogTitle>
                <AlertDialogDescription className="text-white">
                  Nếu bạn thoát trận thì sẽ bị xử thua. Hành động này không thể
                  hoàn tác.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                <AlertDialogCancel className="bg-black border-green-600 hover:bg-black hover:text-white cursor-pointer">
                  Quay lại
                </AlertDialogCancel>
                <AlertDialogAction
